...
export async function GET() {
  ...
  const lines: string[] = [
    ...
    '- Pricing on the web: $12.99/month, or $97/year (about $8.08/month). In the iOS app, bought through Apple: $8.99/month or $79.99/year. The difference is the purchase platform, not the buyer’s region. The annual plan includes a 3-day free trial; cancel anytime',
