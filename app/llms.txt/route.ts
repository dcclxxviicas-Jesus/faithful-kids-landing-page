...
export async function GET() {
  ...
  const lines: string[] = [
    ...
    '- The app pairs each story with a 60-second video lesson and quiz (3-day free trial at https://faithfulkids.app/quiz)',
    '',
    '## Main pages',
    '',
    ...
    '- [Start free trial](https://faithfulkids.app/quiz): Personalized quiz and 3-day free trial',
    '',
