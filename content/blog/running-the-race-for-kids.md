---
title: "Running the Race for Kids: Bible Story Explained Simply"
slug: "running-the-race-for-kids"
...
metaDescription: "Learn the story of Running the Race explained for kids ages 5+. Simple retelling from Romans/Corinthians/Ephesians with a quiz and a free video."
keywords: ["running the race for kids", "running the race bible story", "running the race for children", "running the race explained for kids", "running the race story for kids", "bible stories for kids", "letters to churches for kids", "kids bible", "romans/corinthians/ephesians for kids"]
videoUrl: "/videos/letters-to-churches/running-the-race/lesson-video.mp4"
quizAvailable: true
---

# Running the Race for Kids: The Bible Story Explained Simply
...
1. What was your favorite part of the story of Running the Race?
2. What do you think God was teaching us through this story?
3. How can we be more like Running in our own lives?
...
This retelling of Running the Race is designed for children Ages 7+. The language is simple and age-appropriate, and the video is just a few minutes long, perfect for young attention spans.
...
Yes. Faithful Kids has a short video retelling of Running the Race designed for children, with narration, visuals, and a comprehension quiz. [Watch it here](https://faithfulkids.app/quiz?ref=blog).
