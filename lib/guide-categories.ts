...
export function getGuideCategory(slug: string): string {
  ...
  if (slug === 'faithful-kids-app' || slug.startsWith('bible-apps-') || slug.startsWith('christian-apps-') || slug.includes('-vs-') || slug.includes('best-bible-app') || slug.includes('free-bible-apps') || slug.includes('best-educational') || slug.includes('best-bible-apps') || slug.endsWith('-review')) return 'App Reviews'
  if (slug.includes('scope-and-sequence') || slug.includes('sunday-school') || slug.includes('homeschool') || slug.includes('lesson-plan') || slug.includes('object-lesson') || slug.includes('memory-verse') || slug.includes('bible-study-group') || slug.includes('discussion-questions') || slug.includes('curriculum') || slug.includes('childrens-church') || slug.includes('teaching-the-bible') || slug.includes('teacher-tips')) return 'Teaching'
